  ...
  const printArqueoPDF = (r: any) => {
    ...
    <style>
      *{box-sizing:border-box;margin:0;padding:0}
      ...
      .row.total{font-weight:700;font-size:14px;border-top:2px solid #000;border-bottom:none;padding-top:6px;margin-top:2px}
      .row.dif{font-weight:700;font-size:15px;color:${difColor}}
